...
usersRouter
    ...
    .get([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], userController.getall);
usersRouter
    .route("/signup")
    .options([corsWithOptions], (req, res) => {
    res.sendStatus(StatusCodes.OK);
...
usersRouter
    ...
    .delete([corsWithOptions, authenticate.verifyUser], userController.disallowed);
// usersRouter
