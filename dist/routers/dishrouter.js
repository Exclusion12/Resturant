...
dishrouter
    ...
    .put([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], (req, res) => {
    res.statusCode = 403;
    res.end("PUT operations is not allowed !");
})
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], dishController.removeall);
dishrouter
    .route("/:dishId")
    .options(corsWithOptions, (req, res) => {
    res.sendStatus(StatusCodes.OK);
    ...
    .post([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], (req, res) => {
    res.statusCode = 403;
    ...
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], dishController.deleteone);
//comments section
dishrouter
    ...
    res.statusCode = 403;
    res.end("PUT operations is not allowed on /dishes/" +
        req.params.dishId +
        "/comments");
})
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], commentsController.removeall);
dishrouter
    ...
    .post([corsWithOptions, authenticate.verifyUser], (req, res) => {
    res.statusCode = 403;
    res.end("POST operations is not allowed on /dishes" +
        req.params.dishId +
        "/comments/" +
        req.params.commentId);
})
    .put([corsWithOptions, authenticate.verifyUser], commentsController.updateone)
    .delete([corsWithOptions, authenticate.verifyUser], commentsController.deleteone);
