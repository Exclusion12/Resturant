...
promoRouter
    ...
    .put([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], promoController.disallowed)
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], promoController.deleteall);
promoRouter
    .route("/:promoId")
    .options([corsWithOptions], (req, res) => {
    ...
    .post([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], promoController.disallowed)
    .put([
    corsWithOptions,
    authenticate.verifyUser,
    authenticate.verifyAdmin,
    ...
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], promoController.deleteone);
