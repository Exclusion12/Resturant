...
leaderRouter
    ...
    .put([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], leaderController.disallowed)
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], leaderController.deleteall);
leaderRouter
    .route("/:leaderId")
    .options([corsWithOptions], (req, res) => {
    res.sendStatus(StatusCodes.OK);
    ...
    .post([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], leaderController.disallowed)
    .put([
    corsWithOptions,
    authenticate.verifyUser,
    authenticate.verifyAdmin,
    ...
    .delete([corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin], leaderController.deleteone);
